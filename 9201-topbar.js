...
(function () {
  ...
  <div class="topbar">
    ...
    <div class="topbar-right">
      ...
      <button class="menu-toggle" onclick="window.Sidebar9201&&Sidebar9201.toggleSidebar?Sidebar9201.toggleSidebar():(document.getElementById('sidebar')&&document.getElementById('sidebar').classList.toggle('open'))" aria-label="Buka menu">&#9776;</button>
    </div>
  </div>
  `;
